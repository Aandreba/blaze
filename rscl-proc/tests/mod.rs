...
use rscl::{context::SimpleContext, prelude::{Result, Event}, event::WaitList, buffer::{Buffer, flags::MemAccess}};
...
fn test () -> Result<()> {
    ...
    let mut out = Buffer::<f32>::new_uninit(5, MemAccess::default(), false)?;
